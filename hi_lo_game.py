...
print("Correct guess adds 20 points, wrong one costs 25 points")
print(f"You start with {STARTING_SCORE} points.")
...
# Main loop of the game that reverts back here if 'go again' at the bottom is 'y', else breaks out and ends
while True:
    ...
    print(
        f"This is the starting card: {card['rank']} of {card['suit']}, value: {card['value']}"
        + "\n"
    )
